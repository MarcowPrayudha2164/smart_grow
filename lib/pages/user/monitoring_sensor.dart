...
class UserMonitoringScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: const BodyMonitoringUser());
  }
}

class BodyMonitoringUser extends StatefulWidget {
  const BodyMonitoringUser({super.key});

  @override
  State<BodyMonitoringUser> createState() => _BodyMonitoringUserState();
}

class _BodyMonitoringUserState extends State<BodyMonitoringUser> {
  @override
  Widget build(BuildContext context) {
    return ListView(
      shrinkWrap: true,
